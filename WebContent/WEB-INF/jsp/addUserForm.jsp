	...
	<div class="row">
		...
		<div class="col-8">
			<form class="form-adduser" action="/ActionLogger/adduser"
				...
				<div class="mb-3">
					<label for="userid"><span class="badge badge-danger">必須</span> ユーザーID</label> <input type="text"
						class="form-control" id="userid" name="userid"
						placeholder="ユーザーID" required>
					<div class="invalid-feedback">必須</div>
				</div>
				<div class="mb-3">
					<label for="password"><span class="badge badge-danger">必須</span> パスワード</label> <input type="password"
						class="form-control" id="password" name="password"
						placeholder="パスワード" 　required>
					<div class="invalid-feedback">必須</div>
				</div>
				<div class="mb-3">
					<label for="name"><span class="badge badge-danger">必須</span> 氏名</label> <input type="text"
						class="form-control" id="name" name="name" placeholder="氏名"
						　required>
					<div class="invalid-feedback">必須</div>
				</div>
				<div class="mb-3">
					<label for="address"><span class="badge badge-danger">必須</span> 住所</label> <input type="text"
						class="form-control" id="address" name="address" placeholder="住所">
				</div>
				<div class="mb-3">
					<label for="tel"><span class="badge badge-danger">必須</span> 電話番号</label> <input type="text"
				...
				<div class="mb-3">
					<label for="email"><span class="badge badge-danger">必須</span> メールアドレス</label> <input type="text"
